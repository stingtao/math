...
const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS public_aliases (learner_id TEXT NOT NULL REFERENCES learners(id) ON DELETE CASCADE, scope TEXT NOT NULL, scope_key TEXT NOT NULL, public_id TEXT NOT NULL, nickname TEXT NOT NULL, avatar_glyph TEXT NOT NULL, avatar_tone TEXT NOT NULL, frame TEXT NOT NULL DEFAULT 'plain', created_at TEXT NOT NULL, PRIMARY KEY (learner_id, scope, scope_key))`,
  `CREATE TABLE IF NOT EXISTS learner_preferences (learner_id TEXT PRIMARY KEY REFERENCES learners(id) ON DELETE CASCADE, theme TEXT NOT NULL DEFAULT 'classic', updated_at TEXT NOT NULL)`,
  ...
  `CREATE TABLE IF NOT EXISTS lesson_mastery_checks (learner_id TEXT NOT NULL REFERENCES learners(id) ON DELETE CASCADE, lesson_id TEXT NOT NULL, question_id TEXT NOT NULL, run_id TEXT NOT NULL, round INTEGER NOT NULL DEFAULT 0, attempts INTEGER NOT NULL DEFAULT 1, hints_used INTEGER NOT NULL DEFAULT 0, clean_corrected INTEGER NOT NULL DEFAULT 0, updated_at TEXT NOT NULL, PRIMARY KEY (learner_id, lesson_id, question_id))`,
  ...
  `CREATE TABLE IF NOT EXISTS lesson_progress (learner_id TEXT NOT NULL REFERENCES learners(id) ON DELETE CASCADE, lesson_id TEXT NOT NULL, stars INTEGER NOT NULL DEFAULT 1, first_correct_count INTEGER NOT NULL DEFAULT 0, question_count INTEGER NOT NULL DEFAULT 5, completed_at TEXT NOT NULL, PRIMARY KEY (learner_id, lesson_id))`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_lesson_mastery_run ON lesson_mastery_checks(learner_id, lesson_id, run_id)`,
