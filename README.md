...
`npm test` builds the production app, validates all 253 lessons and 1,297 reviewed questions, runs 129,700 seeded answer checks, confirms the Grade 8 Quick Sheets, checks all 73 Grade 7, Grade 8, and high-school Common Core clusters plus the Algebra, state, AP, and Kang Chiao/IB extensions, verifies privacy boundaries, and exercises mutation, recovery-mastery, reward, responsive-layout, and security controls.
