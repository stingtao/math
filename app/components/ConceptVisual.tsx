...
export function ConceptVisual({ lesson }: { lesson: LessonDefinition }) {
  ...
  if (["g9-quantities-units-precision", "g9-absolute-value-functions", "g9-absolute-value-inequalities", "g9-graph-linear-inequalities", "g9-systems-linear-inequalities", "g9-build-quadratic-models", "g9-interpret-linear-models"].includes(lesson.slug)) return coverageVisual;
