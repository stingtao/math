...
export function getThemeJourney(theme: ThemeId, progress: { lessons: number; bosses: number; dueReview: number }): ThemeJourney {
  ...
  return {
    ...
    location,
    nextLocation,
    headline: `${spec.levelLabel} ${stage} · ${location}`,
