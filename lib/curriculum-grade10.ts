...
export const grade10Regions: RegionDefinition[] = [
  makeRegion(1, "Reasoning and Proof", "Build valid arguments from definitions, diagrams, and theorems.", "HSG.CO.A–C", [
    ...
    { slug: "angle-proofs", title: "Angle Relationships", goal: "Use vertical, complementary, and supplementary angle facts.", key: "Vertical angles are congruent; a linear pair sums to 180°; complementary angles sum to 90°.", example: "3x + 10 and 5x − 30 are vertical, so x = 20", standard: "HSG.CO.C.9", visual: "angles", drills: [
  ...
  makeRegion(3, "Similarity and Right Triangles", "Scale figures and solve right triangles with ratios.", "HSG.SRT.A–C", [
    ...
    { slug: "triangle-similarity", title: "Triangle Similarity", goal: "Use AA, SAS, or SSS similarity.", key: "AA needs two equal angles; SAS and SSS compare proportional side lengths.", example: "Two angles match, so the triangles are similar by AA", standard: "HSG.SRT.A.2–3", visual: "triangle", drills: [
      ["Two matching angle pairs prove similarity by?", "AA"], ["Sides 3,4,5 and 6,8,10 are similar by?", "SSS"], ["A triangle has angles 40°, 60°, 80°. A similar triangle must have what angles?", "40,60,80|40°,60°,80°"], ["If scale factor is 2 and small side is 7, large side?", "14"], ["Are all right triangles similar?", "no"],
    ] },
  ...
  makeRegion(4, "Coordinate Geometry", "Prove geometric facts and model figures on the coordinate plane.", "HSG.GPE.B", [
    ...
    { slug: "parallel-perpendicular", title: "Parallel and Perpendicular Lines", goal: "Use slopes to classify line relationships.", key: "Parallel nonvertical lines have equal slopes; perpendicular slopes have product −1.", example: "Slopes 2/3 and −3/2 are perpendicular", standard: "HSG.GPE.B.5", visual: "line-graph", drills: [
      ["Are slopes 4 and 4 parallel or perpendicular?", "parallel"], ["A line perpendicular to slope 2 has slope?", "-1/2"], ["A line parallel to y = −3x + 1 has slope?", "-3"], ["Are slopes 1/3 and −3 perpendicular?", "yes"], ["Vertical and horizontal lines are?", "perpendicular"],
    ] },
    { slug: "coordinate-proofs", title: "Coordinate Proofs", goal: "Use slope and distance to prove shape properties.", key: "Show equal side lengths, parallel slopes, or perpendicular slopes that match the shape definition.", example: "Four equal side lengths and one right angle prove a square", standard: "HSG.GPE.B.4–5", visual: "coordinate", drills: [
